...
function App() {
	return (
		<>
			<DebugMenu />
			<Routes>
				{/* Open parent- en login-routes */}
				<Route path="/Parents/Login" element={<AuthLayout><ParentsLogin /></AuthLayout>} />
				<Route path="/Parents/Appointment" element={<AuthLayout><Appointment /></AuthLayout>} />
